...
public enum ReplacementRuleType implements Rule {
	...
	TAUTOLOGY(new ReplacementRuleActioner() {
		...
		public boolean check(Formula f1, Formula f2) {
			...
			for(Formula f : FormulaBalancer.getAllFormulas(cache, (formula) -> formula.getPrimary(false).isAction(), false)) {
				...
				if(f.isPremise())
					if(f.getPrimary(false).getAction().getType().is(ActionType.AND, ActionType.OR)) {
	...
	COMMUTATIVITY(new ReplacementRuleActioner() {
		...
		public boolean check(Formula f1, Formula f2) {
			...
			if(f1.isAtomicPremise()) {
				if(f1.getPrimary(false).getAction().getType().is(ActionType.AND, ActionType.OR)) {
	...
	DISTRIBUTION(new ReplacementRuleActioner() {
		...
		public boolean check(Formula f1, Formula f2) {
			...
			for(Formula f : FormulaBalancer.getAllPremises(cache, (formula) -> formula.getPrimary(true).isAction() && formula.getPrimary(false).getAction().getType().is(ActionType.AND, ActionType.OR), false)) {
				
				List<Formula> dist = new ArrayList<Formula>();
				
				if(f.isPremise()) {
					
					if(f.getPrimary(true).getAction().getType().is(ActionType.AND)) {
						
						if(f.getNode(0).toFormula().isPremise() && f.getNode(2).toFormula().isPremise() && f.getNode(0).toFormula().getPrimary(true).getAction().getType().is(ActionType.OR) && f.getNode(2).toFormula().getPrimary(true).getAction().getType().is(ActionType.OR)) {
							
							dist.add(new Formula(f.getAttached(), 
					                 f.getNode(0).toFormula().getNode(0).toFormula(),
					                 ActionType.OR.getAction(),
					                 builder.action(f.getNode(0).toFormula().getNode(2).toFormula(), f.getNode(2).toFormula().getNode(2).toFormula(), ActionType.AND)));
							
						} else if(f.getNode(2).toFormula().getPrimary(true).getAction().getType().is(ActionType.OR)) {
							
							dist.add(new Formula(f.getAttached(), 
								                 builder.action(f.getNode(0).toFormula().getNode(0).toFormula(), f.getNode(2).toFormula().getNode(0).toFormula(), ActionType.AND),
								                 ActionType.OR.getAction(),
								                 builder.action(f.getNode(0).toFormula().getNode(0).toFormula(), f.getNode(2).toFormula().getNode(2).toFormula(), ActionType.AND)));
							
						}
						
					} else {
						
						if(f.getNode(0).toFormula().isPremise() && f.getNode(2).toFormula().isPremise() && f.getNode(0).toFormula().getPrimary(true).getAction().getType().is(ActionType.AND) && f.getNode(2).toFormula().getPrimary(true).getAction().getType().is(ActionType.AND)) {
							
							dist.add(new Formula(f.getAttached(), 
					                 f.getNode(0).toFormula().getNode(0).toFormula(),
					                 ActionType.AND.getAction(),
					                 builder.action(f.getNode(0).toFormula().getNode(2).toFormula(), f.getNode(2).toFormula().getNode(2).toFormula(), ActionType.OR)));
							
						} else if(f.getNode(2).toFormula().getPrimary(true).getAction().getType().is(ActionType.OR)) {
							
							dist.add(new Formula(f.getAttached(), 
								                 builder.action(f.getNode(0).toFormula().getNode(0).toFormula(), f.getNode(2).toFormula().getNode(0).toFormula(), ActionType.OR),
								                 ActionType.AND.getAction(),
								                 builder.action(f.getNode(0).toFormula().getNode(0).toFormula(), f.getNode(2).toFormula().getNode(2).toFormula(), ActionType.OR)));
			...
			for(Formula f : FormulaBalancer.getAllPremises(cache, (formula) -> formula.getPrimary(true).isAction() && formula.getPrimary(false).getAction().getType().is(ActionType.AND, ActionType.OR), false)) {
				...
				if(f.isPremise()) {
					...
					if(f.getPrimary(true).getAction().getType().is(ActionType.AND)) {
						...
						if(f.getNode(0).toFormula().isPremise() && !f.getNode(2).toFormula().getPrimary(true).getAction().getType().is(ActionType.AND)) {
							if(f.getNode(0).toFormula().getPrimary(true).getAction().getType().is(ActionType.AND)) {
								
								assoc.add(new Formula(f.getAttached(), 
												      f.getNode(0).toFormula().getNode(0),
												      ActionType.AND.getAction(),
												      builder.action(f.getNode(0).toFormula().getNode(2).toFormula(), f.getNode(2).toFormula(), ActionType.AND)));
								
							}
						} else if(f.getNode(2).toFormula().isPremise() && !f.getNode(0).toFormula().getPrimary(true).getAction().getType().is(ActionType.AND)) {
							if(f.getNode(2).toFormula().getPrimary(true).getAction().getType().is(ActionType.AND)) {
								
								assoc.add(new Formula(f.getAttached(), 
													  builder.action(f.getNode(0).toFormula(), f.getNode(2).toFormula().getNode(0).toFormula(), ActionType.AND),
									    		      ActionType.AND.getAction(),
						...
						if(f.getNode(0).toFormula().isPremise() && !f.getNode(2).toFormula().getPrimary(true).getAction().getType().is(ActionType.OR)) {
							if(f.getNode(0).toFormula().getPrimary(true).getAction().getType().is(ActionType.OR)) {
								
								assoc.add(new Formula(f.getAttached(), 
												      f.getNode(0).toFormula().getNode(0),
												      ActionType.OR.getAction(),
												      builder.action(f.getNode(0).toFormula().getNode(2).toFormula(), f.getNode(2).toFormula(), ActionType.OR)));
								
							}
						} else if(f.getNode(2).toFormula().isPremise() && !f.getNode(0).toFormula().getPrimary(true).getAction().getType().is(ActionType.OR)) {
							if(f.getNode(2).toFormula().getPrimary(true).getAction().getType().is(ActionType.OR)) {
								
								assoc.add(new Formula(f.getAttached(), 
												      builder.action(f.getNode(0).toFormula(), f.getNode(2).toFormula().getNode(0).toFormula(), ActionType.OR),
									    		      ActionType.OR.getAction(),
									    		      f.getNode(2).toFormula().getNode(2)));
	...
	DOUBLE_NEGATION(new ReplacementRuleActioner() {
		...
		public boolean check(Formula f1, Formula f2) {
			...
			for(Formula f : FormulaBalancer.getAllFormulas(cache, (formula) -> true, false)) {
				...
				if(f.getAttached().size() > 0) {
					...
					K : for(int i = 0; i < f.getAttached().size(); i++) {
						...
						if(!founded && (i + 1) < f.getAttached().size() && f.getAttached().get(i).isAction() && f.getAttached().get(i + 1).isAction())
							if(f.getAttached().get(i).getAction().getType() == ActionType.NO)
								if(f.getAttached().get(i + 1).getAction().getType() == ActionType.NO) {
				...
				for(int i = 0; i < 2; i++)
					newAdAttached.addFirst(ActionType.NO.getAction().setMaster(f).getAction());
			...
			for(Formula f : FormulaBalancer.getAllFormulas(cache, (formula) -> formula.getPrimary(false).isAction(), false)) {
				...
				if(f.isPremise()) {
					...
					if(f.getNode(0).toFormula().isPremise()) {
						if(f.getNode(0).toFormula().getPrimary(true).getAction().getType().is(ActionType.AND)) {
							...
							exp.add(new Formula(f.getAttached(), 
											    f.getNode(0).toFormula().getNode(0),
											    ActionType.SO.getAction(),
											    builder.action(f.getNode(0).toFormula().getNode(2).toFormula(), f.getNode(2).toFormula(), ActionType.SO)));
					...
					if(f.getNode(2).toFormula().isPremise()) {
						if(f.getNode(2).toFormula().getPrimary(true).getAction().getType().is(ActionType.SO)) {
	...
	MATERIAL_EQUIVALENCE(new ReplacementRuleActioner() {
		...
		public boolean check(Formula f1, Formula f2) {
			...
			for(Formula f : FormulaBalancer.getAllPremises(cache, (formula) -> formula.getPrimary(false).isAction() && formula.getPrimary(false).getAction().getType().is(ActionType.BICONDITIONAL, ActionType.AND, ActionType.OR), false)) {
					...
					switch(f.getPrimary(false).getAction().getType()) {
						...
						case BICONDITIONAL: {
							...
							matequiv.add(new Formula(f.getAttached(), 
												     builder.action(f.getNodes().get(0).toFormula(), f.getNodes().get(2).toFormula(), ActionType.SO),
												     ActionType.AND.getAction(),
												     builder.action(f.getNodes().get(2).toFormula(), f.getNodes().get(0).toFormula(), ActionType.SO)));
							matequiv.add(new Formula(f.getAttached(),
													 builder.action(f.getNodes().get(0).toFormula(), f.getNodes().get(2).toFormula(), ActionType.AND),
													 ActionType.OR.getAction(),
												     builder.action(f.getNodes().get(0).toFormula().clone().swapOpposite(), f.getNodes().get(2).toFormula().clone().swapOpposite(), ActionType.AND)));
						...
						case AND: {
							...
							if(f.getNode(0).isFormula() && f.getNode(2).isFormula())
								if(f.getNode(0).getFormula().getPrimary(false).getAction().getType().is(ActionType.SO))
									if(f.getNode(2).getFormula().getPrimary(false).getAction().getType().is(ActionType.SO))
										if(f.getNode(0).getFormula().getNode(0).equals(f.getNode(2).getFormula().getNode(2)))
											if(f.getNode(0).getFormula().getNode(2).equals(f.getNode(2).getFormula().getNode(0)))
												matequiv.add(new Formula(f.getAttached(),
														 				 ...
														 				 ActionType.BICONDITIONAL.getAction(),
						...
						case OR: {
							if(f.getNode(0).isFormula() && f.getNode(2).isFormula())
								if(f.getNode(0).getFormula().getPrimary(false).getAction().getType().is(ActionType.AND))
									if(f.getNode(2).getFormula().getPrimary(false).getAction().getType().is(ActionType.AND))
		...
		public boolean check(Formula f1, Formula f2) {
			...
			for(Formula f : premises) {
				...
				if(f.isPremise()) {
					...
					} else if(f.getPrimary(false).getAction().getType().is(ActionType.OR)) {
	...
	DEMORGAN(new ReplacementRuleActioner() {
		...
		public boolean check(Formula f1, Formula f2) {
			...
			for(Formula f : FormulaBalancer.getAllPremises(cache, (formula) -> formula.getPrimary(false).isAction() && formula.getPrimary(false).getAction().getType().is(ActionType.AND, ActionType.OR), false)) {
				
				List<Formula> dm = new ArrayList<Formula>();
				
				if(f.isPremise()) {
					
					if(f.getPrimary(false).getAction().getType().is(ActionType.AND)) {
